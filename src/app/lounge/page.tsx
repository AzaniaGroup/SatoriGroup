...
import { ChairIcon, DoorIcon, FireIcon, CigarIcon } from '@/components/SatoriIcons';
...
export default function LoungePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="satori-hero-enhanced">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-br from-dark-brown/70 via-dark-brown/50 to-copper/40"></div>
        </div>
        ...
        >
          <motion.p
            className="satori-caption text-champagne-gold mb-8"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <h1 className="satori-display text-5xl md:text-7xl mb-8 text-ivory">
            After Work, Redefined.
          </h1>
          <p className="satori-body text-xl md:text-2xl max-w-4xl mx-auto text-ivory/90 mb-12">
            Nestled in Bryanston, this is a sanctuary for conversation and reflection.
            Here, time slows down — whiskey breathes, jazz plays, and the world becomes intimate again.
          </p>
          <Dialog open={isBookingOpen} onOpenChange={setIsBookingOpen}>
            <DialogTrigger asChild>
              <button className="satori-button-elegant text-ivory border-ivory hover:bg-ivory hover:text-dark-brown">
                Reserve Your Table
              </button>
            </DialogTrigger>
            ...
            {[
              ...
              >
                <div className="mb-4 flex justify-center">
                  <feature.icon className="text-copper" size={40} />
                </div>
      ...
      <section className="satori-section bg-dark-brown text-ivory">
        <div className="satori-container">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="satori-heading text-4xl mb-6 text-white">
      ...
      <section className="satori-section bg-champagne-gold/20">
        <div className="satori-container text-center">
          ...
          >
            ...
            <Dialog open={isBookingOpen} onOpenChange={setIsBookingOpen}>
              <DialogTrigger asChild>
                <button className="satori-button-filled bg-copper text-ivory border-copper hover:bg-ivory hover:text-copper">
                  Reserve Your Table
                </button>
              </DialogTrigger>
            </Dialog>
